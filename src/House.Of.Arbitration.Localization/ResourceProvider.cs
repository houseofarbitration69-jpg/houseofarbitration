...
LocalizationResourceManager.Instance.GetValue(nameof(ENUM_GENRE_MIXTE));
    /// <summary>
    /// Gets the translated "CHOOSE_AGE_RANGE" string.
    /// </summary>
...
LocalizationResourceManager.Instance.GetValue(nameof(RING));
    /// <summary>
    /// Gets the translated "CLEAR_DATA" string.
    /// </summary>
    public string CLEAR_DATA =>
LocalizationResourceManager.Instance.GetValue(nameof(CLEAR_DATA));
    /// <summary>
    /// Gets the translated "CONFIRM_CLEAR_DATA_MESSAGE" string.
    /// </summary>
    public string CONFIRM_CLEAR_DATA_MESSAGE =>
LocalizationResourceManager.Instance.GetValue(nameof(CONFIRM_CLEAR_DATA_MESSAGE));
    /// <summary>
    /// Gets the translated "DATA_CLEARED" string.
    /// </summary>
    public string DATA_CLEARED =>
LocalizationResourceManager.Instance.GetValue(nameof(DATA_CLEARED));
    /// <summary>
    /// Gets the translated "DATA_GENERATED" string.
    /// </summary>
    public string DATA_GENERATED =>
LocalizationResourceManager.Instance.GetValue(nameof(DATA_GENERATED));
